...
complexQ({
    ...
    correct: {
      en: "To enhance visual appeal and readability",
      fr: "Pour améliorer l’attrait visuel et la lisibilité",
    },
    distractors: [
      { en: "To make the website more interactive", fr: "Pour rendre le site Web plus interactif" },
    ...
    explanation: {
      en: "Source Odoo Learn (Design your website: text and colors): To enhance visual appeal and readability",
...
complexQ({
    ...
    correct: {
      en: "To follow guidelines that ensure websites are easy to use",
      fr: "Suivre les directives qui garantissent que les sites Web sont faciles à utiliser",
    },
    distractors: [
      { en: "To create complex website layouts", fr: "Pour créer des mises en page de sites Web complexes" },
    ...
    explanation: {
      en: "Source Odoo Learn (Design your website: text and colors): To follow guidelines that ensure websites are easy to use",
...
complexQ({
    ...
    explanation: {
      en: "Source Odoo Learn (Design your website: text and colors): Theme",
...
complexQ({
    ...
    correct: {
      en: "Direct users to take a specific action",
      fr: "Inviter les utilisateurs à effectuer une action spécifique",
    },
    distractors: [
      { en: "Enhance website aesthetics", fr: "Améliorer l'esthétique du site Web" },
    ...
    explanation: {
      en: "Source Odoo Learn (Design your website: text and colors): Direct users to take a specific action",
...
complexQ({
    ...
    distractors: [
      { en: "Only the color palette", fr: "Seule la palette de couleurs" },
      { en: "Only the logo", fr: "Seulement le logo" },
      { en: "Nothing", fr: "Rien" },
    ],
    explanation: {
      en: "Source Odoo Learn (Website configurator): Everything",
...
complexQ({
    ...
    correct: {
      en: "Among others, it affects the main button on the website",
      fr: "Entre autres, cela affecte le bouton principal du site Web",
    },
    distractors: [
      { en: "It determines the industry-specific templates available", fr: "Il détermine les modèles spécifiques à l'industrie disponibles" },
    ...
    explanation: {
      en: "Source Odoo Learn (Website configurator): Among others, it affects the main button on the website",
...
complexQ({
    ...
    correct: {
      en: "To tailor the website's content and features",
      fr: "Pour adapter le contenu et les fonctionnalités du site Web",
    },
    distractors: [
      { en: "To determine the primary color scheme", fr: "Pour déterminer la palette de couleurs primaires" },
    ...
    explanation: {
      en: "Source Odoo Learn (Website configurator): To tailor the website's content and features",
...
complexQ({
    ...
    correct: {
      en: "They create a modern and dynamic aesthetic backdrop that harmonizes the pages",
      fr: "Ils créent un décor esthétique moderne et dynamique qui harmonise les pages",
    },
    distractors: [
      { en: "They provide interactive animations for user engagement", fr: "Ils fournissent des animations interactives pour l’engagement des utilisateurs" },
    ...
    explanation: {
      en: "Source Odoo Learn (Design your website: images and motion): They create a modern and dynamic aesthetic backdrop that harmonizes the pages",
...
complexQ({
    ...
    correct: {
      en: "They improve website loading speed",
      fr: "Ils améliorent la vitesse de chargement du site Web",
    },
    distractors: [
      { en: "They offer higher resolution than JPEG images", fr: "Ils offrent une résolution plus élevée que les images JPEG" },
    ...
    explanation: {
      en: "Source Odoo Learn (Design your website: images and motion): They improve website loading speed",
...
complexQ({
    ...
    correct: {
      en: "Because most of the forms’ customizable settings depend on the action",
      fr: "Parce que la plupart des paramètres personnalisables des formulaires dépendent de l'action",
    },
    distractors: [
      { en: "To ensure the form layout is visually appealing", fr: "Pour garantir que la mise en page du formulaire est visuellement attrayante" },
    ...
    explanation: {
      en: "Source Odoo Learn (Contact forms): Because most of the forms’ customizable settings depend on the action",
...
complexQ({
    ...
    correct: {
      en: "Hide specific fields based on user input",
      fr: "Masquer des champs spécifiques en fonction de la saisie de l'utilisateur",
    },
    distractors: [
      { en: "Customize field labels", fr: "Personnaliser les étiquettes des champs" },
    ...
    explanation: {
      en: "Source Odoo Learn (Contact forms): Hide specific fields based on user input",
...
complexQ({
    ...
    correct: {
      en: "By specifying a redirect page",
      fr: "En spécifiant une page de redirection",
    },
    distractors: [
      { en: "By adjusting the font size", fr: "En ajustant la taille de la police" },
    ...
    explanation: {
      en: "Source Odoo Learn (Contact forms): By specifying a redirect page",
...
complexQ({
    ...
    correct: {
      en: "To navigate to specific sections within a page",
      fr: "Pour accéder à des sections spécifiques dans une page",
    },
    distractors: [
      { en: "To redirect users to external websites", fr: "Pour rediriger les utilisateurs vers des sites Web externes" },
    ...
    explanation: {
      en: "Source Odoo Learn (Navigation: links & menus): To navigate to specific sections within a page",
...
complexQ({
    ...
    correct: {
      en: "Shift an item to the right",
      fr: "Déplacer un élément vers la droite",
    },
    distractors: [
      { en: "Drag and drop items vertically", fr: "Glissez et déposez des éléments verticalement" },
    ...
    explanation: {
      en: "Source Odoo Learn (Navigation: links & menus): Shift an item to the right",
...
complexQ({
    ...
    distractors: [
      { en: "External Menu", fr: "Menu externe" },
      { en: "Anchor Menu", fr: "Menu d'ancrage" },
      { en: "Shortcut Menu", fr: "Menu contextuel" },
    ],
    explanation: {
      en: "Source Odoo Learn (Navigation: links & menus): Megamenu",
...
complexQ({
    ...
    correct: {
      en: "To reach a larger audience",
      fr: "Pour toucher un public plus large",
    },
    distractors: [
      { en: "To enhance the website's visual appeal", fr: "Pour améliorer l'attrait visuel du site Web" },
    ...
    explanation: {
      en: "Source Odoo Learn (Translations): To reach a larger audience",
...
complexQ({
    ...
    correct: {
      en: "It automatically translates identical text across the website",
      fr: "Il traduit automatiquement le texte identique sur le site Web",
    },
    distractors: [
      { en: "It provides a list of common translations for each language", fr: "Il fournit une liste de traductions courantes pour chaque langue" },
    ...
    explanation: {
      en: "Source Odoo Learn (Translations): It automatically translates identical text across the website",
...
mcq3Q({
    ...
    correct: {
      en: "The main language allows full editing capabilities, while other languages are restricted to translation only.",
      fr: "La langue principale permet des capacités d'édition complètes, tandis que les autres langues sont limitées à la traduction uniquement.",
    },
    distractors: [
      { en: "The main language is used for backend operations, while other languages are for frontend display.", fr: "La langue principale est utilisée pour les opérations back-end, tandis que les autres langues sont destinées à l'affichage front-end." },
    ...
    explanation: {
      en: "Source Odoo Learn (Translations): The main language allows full editing capabilities, while other languages are restricted to translation only.",
...
complexQ({
    ...
    correct: {
      en: "Because mobile devices have smaller screens.",
      fr: "Parce que les appareils mobiles ont des écrans plus petits.",
    },
    distractors: [
      { en: "To hide certain elements from desktop users.", fr: "Pour masquer certains éléments aux utilisateurs de bureau." },
    ...
    explanation: {
      en: "Source Odoo Learn (Mobile version): Because mobile devices have smaller screens.",
...
complexQ({
    ...
    explanation: {
      en: "Source Odoo Learn (Mobile version): Bootstrap",
...
complexQ({
    ...
    correct: {
      en: "By automatically stacking elements using Bootstrap grids.",
      fr: "En empilant automatiquement les éléments à l'aide de grilles Bootstrap.",
    },
    distractors: [
      { en: "By using conditional formatting.", fr: "En utilisant la mise en forme conditionnelle." },
    ...
    explanation: {
      en: "Source Odoo Learn (Mobile version): By automatically stacking elements using Bootstrap grids.",
...
complexQ({
    ...
    correct: {
      en: "www.goodexample.com",
      fr: "www.bonexemple.com",
    },
    distractors: [
      { en: "www.good-example.com", fr: "www.bon-exemple.com" },
    ...
    explanation: {
      en: "Source Odoo Learn (Register a free domain name): www.goodexample.com",
...
complexQ({
    ...
    correct: {
      en: "Trust-building, SEO improvement, audience engagement",
      fr: "Renforcement de la confiance, amélioration du référencement, engagement du public",
    },
    distractors: [
      { en: "Video creation, mobile optimization, engagement", fr: "Création vidéo, optimisation mobile, engagement" },
    ...
    explanation: {
      en: "Source Odoo Learn (Blogs): Trust-building, SEO improvement, audience engagement",
...
complexQ({
    ...
    correct: {
      en: "Update your blog at least once a week",
      fr: "Mettez à jour votre blog au moins une fois par semaine",
    },
    distractors: [
      { en: "Post at least once a month", fr: "Postez au moins une fois par mois" },
    ...
    explanation: {
      en: "Source Odoo Learn (Blogs): Update your blog at least once a week",
...
complexQ({
    ...
    correct: {
      en: "By hitting the \"/ key\" and selecting from the menu",
      fr: "En appuyant sur la touche \"/\" et en sélectionnant dans le menu",
    },
    distractors: [
      { en: "By using the \"Insert Media\" button", fr: "En utilisant le bouton \"Insérer un média\"" },
    ...
    explanation: {
      en: "Source Odoo Learn (Blogs): By hitting the \"/ key\" and selecting from the menu",
...
complexQ({
    ...
    correct: {
      en: "For SEO purposes and to boost website ranking",
      fr: "À des fins de référencement et pour améliorer le classement du site Web",
    },
    distractors: [
      { en: "To make the content more visually appealing", fr: "Pour rendre le contenu plus attrayant visuellement" },
    ...
    explanation: {
      en: "Source Odoo Learn (Blogs): For SEO purposes and to boost website ranking",
...
mcq3Q({
    ...
    distractors: [
      { en: "Robots.txt", fr: "Robots.txt" },
      { en: "Hreflang tags", fr: "Balises hreflang" },
    ],
    explanation: {
      en: "Source Odoo Learn (Search Engine Optimization (SEO)): Sitemaps",
...
mcq3Q({
    ...
    correct: {
      en: "To give search engines an idea of the structure of your content.",
      fr: "Pour donner aux moteurs de recherche une idée de la structure de votre contenu.",
    },
    distractors: [
      { en: "To improve the visual design of the page.", fr: "Pour améliorer la conception visuelle de la page." },
      { en: "To increase the loading speed of the page.", fr: "Pour augmenter la vitesse de chargement de la page." },
    ],
    explanation: {
      en: "Source Odoo Learn (Search Engine Optimization (SEO)): To give search engines an idea of the structure of your content.",
...
mcq3Q({
    ...
    correct: {
      en: "To understand visitor behavior and improve website performance.",
      fr: "Comprendre le comportement des visiteurs et améliorer les performances du site Web.",
    },
    distractors: [
      { en: "To improve the visual design of your website.", fr: "Pour améliorer la conception visuelle de votre site Web." },
      { en: "To manage your website's backend settings.", fr: "Pour gérer les paramètres backend de votre site Web." },
    ],
    explanation: {
      en: "Source Odoo Learn (Website analytics): To understand visitor behavior and improve website performance.",
...
mcq3Q({
    ...
    correct: {
      en: "Someone who is counted only once regardless of multiple visits.",
      fr: "Quelqu'un qui n'est compté qu'une seule fois, quelles que soient les visites multiples.",
    },
    distractors: [
      { en: "Someone who visits multiple pages on your website.", fr: "Quelqu'un qui visite plusieurs pages de votre site Web." },
    ...
    explanation: {
      en: "Source Odoo Learn (Website analytics): Someone who is counted only once regardless of multiple visits.",
...
mcq3Q({
    ...
    correct: {
      en: "The Odoo apps installed and the database used.",
      fr: "Les applications Odoo installées et la base de données utilisée.",
    },
    distractors: [
      { en: "The website themes and domain names.", fr: "Les thèmes du site et les noms de domaine." },
      { en: "The email addresses for contact forms.", fr: "Les adresses email des formulaires de contact." },
    ],
    explanation: {
      en: "Source Odoo Learn (Multi-website): The Odoo apps installed and the database used.",
...
mcq3Q({
    ...
    correct: {
      en: "Adjust the Website field in the product record.",
      fr: "Ajustez le champ Site Web dans la fiche produit.",
    },
    distractors: [
      { en: "Re-upload the product for each website separately.", fr: "Téléchargez à nouveau le produit pour chaque site Web séparément." },
      { en: "Create separate Odoo accounts for each website.", fr: "Créez des comptes Odoo distincts pour chaque site Web." },
    ],
    explanation: {
      en: "Source Odoo Learn (Multi-website): Adjust the Website field in the product record.",
  ...
  complexQ({
    ...
    module: "website",
    text: {
      en: "How can you automate the process of showing a \"NEW\" ribbon on recently published products without manually adding it to every item? (Odoo Learn — Additional features)",
      fr: "Comment pouvez-vous automatiser le processus d'affichage d'un ruban « NOUVEAU » sur les produits récemment publiés sans l'ajouter manuellement à chaque élément ? (Odoo Learn — Fonctionnalités supplémentaires)",
    },
    correct: {
      en: "By configuring the number of days the ribbon should be shown after publication in the \"Ribbons\" settings.",
      fr: "En configurant le nombre de jours pendant lesquels le ruban doit être affiché après publication dans les paramètres \"Rubans\".",
    },
    distractors: [
      { en: "By setting a badge to \"4x4 square size\" in the shop editor.", fr: "En définissant un badge sur \"Taille carré 4x4\" dans l'éditeur de boutique." },
      { en: "By moving the product to the top-left side of the catalog page.", fr: "En déplaçant le produit vers le côté supérieur gauche de la page du catalogue." },
      { en: "By enabling \"Static Search\" in the website toolbar settings.", fr: "En activant la « Recherche statique » dans les paramètres de la barre d'outils du site Web." },
    ],
    explanation: {
      en: "Source Odoo Learn (Additional features): By configuring the number of days the ribbon should be shown after publication in the \"Ribbons\" settings.",
      fr: "Source Odoo Learn (Fonctionnalités supplémentaires) : En configurant le nombre de jours pendant lesquels le ruban doit être affiché après publication dans les paramètres \"Rubans\".",
    },
  }),
  complexQ({
    id: "web-107",
    module: "website",
    text: {
      en: "What action can you take in the website editor to make a specific product (like the fruit mug) more visible on the shop page? (Odoo Learn — Additional features)",
      fr: "Quelle action pouvez-vous entreprendre dans l'éditeur du site Web pour rendre un produit spécifique (comme la tasse de fruits) plus visible sur la page de la boutique ? (Odoo Learn — Fonctionnalités supplémentaires)",
    },
    correct: {
      en: "You can change its size to a 4x4 square and move it to the top left.",
      fr: "Vous pouvez changer sa taille en carré 4x4 et le déplacer vers le haut à gauche.",
    },
    distractors: [
      { en: "You can change its price automatically.", fr: "Vous pouvez modifier son prix automatiquement." },
      { en: "You can delete the surrounding products.", fr: "Vous pouvez supprimer les produits environnants." },
      { en: "You can only view it in the backend dashboard.", fr: "Vous ne pouvez le voir que dans le tableau de bord backend." },
    ],
    explanation: {
      en: "Source Odoo Learn (Additional features): You can change its size to a 4x4 square and move it to the top left.",
      fr: "Source Odoo Learn (Fonctionnalités supplémentaires) : Vous pouvez changer sa taille en carré 4x4 et le déplacer vers le haut à gauche.",
    },
  }),
  complexQ({
    id: "web-108",
    module: "website",
    text: {
      en: "For which three scenarios can Odoo automatically assign specific ribbons or badges to products? (Odoo Learn — Additional features)",
      fr: "Pour quels trois scénarios Odoo peut-il attribuer automatiquement des rubans ou des badges spécifiques aux produits ? (Odoo Learn — Fonctionnalités supplémentaires)",
    },
    correct: {
      en: "New, On Sale, and When out of stock.",
      fr: "Neuf, en vente et en rupture de stock.",
    },
    distractors: [
      { en: "Most viewed, Highest price, and Local pickup.", fr: "Le plus consulté, le prix le plus élevé et le ramassage local." },
      { en: "Free shipping, Discontinued, and Draft.", fr: "Livraison gratuite, discontinué et brouillon." },
      { en: "Pre-order, Featured, and Best-seller.", fr: "Précommande, vedette et best-seller." },
    ],
    explanation: {
      en: "Source Odoo Learn (Additional features): New, On Sale, and When out of stock.",
      fr: "Source Odoo Learn (Fonctionnalités supplémentaires) : Nouveau, En vente et En rupture de stock.",
    },
  }),
  complexQ({
    id: "web-109",
    module: "website",
    text: {
      en: "Based on what criteria does the Comparison tool allow customers to compare different products? (Odoo Learn — Additional features)",
      fr: "Sur la base de quels critères l'outil de comparaison permet-il aux clients de comparer différents produits ? (Odoo Learn — Fonctionnalités supplémentaires)",
    },
    correct: {
      en: "Based on their attributes.",
      fr: "En fonction de leurs attributs.",
    },
    distractors: [
      { en: "Based on their creation date.", fr: "En fonction de leur date de création." },
      { en: "Based on customer review ratings.", fr: "Basé sur les évaluations des clients." },
      { en: "Based on the shipping destination.", fr: "Basé sur la destination d'expédition." },
    ],
    explanation: {
      en: "Source Odoo Learn (Additional features): Based on their attributes.",
      fr: "Source Odoo Learn (Fonctionnalités supplémentaires) : En fonction de leurs attributs.",
    },
  }),
];
